...
namespace CST.Infrastructure.EfCore.Strategy
// ReSharper restore CheckNamespace
{
    /// <summary>
    /// 应用于 <see cref="ITimeOfEntityModel"/> 实现类型的映射策略。
    /// </summary>
    public class TimeMappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(ITimeOfEntityModel));
        }
        ...
        public void Mapping(ModelBuilder builder, Type modelType)
        {
            ...
            typeBuilder.Property(nameof(ITimeOfEntityModel.CreateTime)).IsRequired();
            typeBuilder.Property(nameof(ITimeOfEntityModel.ModifyTime)).IsRequired();
        }
