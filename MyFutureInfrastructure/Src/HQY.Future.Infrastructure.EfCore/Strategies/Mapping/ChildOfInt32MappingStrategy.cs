...
{
    /// <summary>
    /// 应用于 <see cref="IChildEntityModelOfInt32{TChildModel}"/> 实现类型的映射策略。
    /// </summary>
    public class ChildOfInt32MappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(IChildEntityModelOfInt32<>));
        }
        ...
        public virtual void Mapping(ModelBuilder builder, Type modelType)
        {
            ...
            // 映射实体属性。
            typeBuilder.Property(nameof(IChildEntityModelOfInt32<EntityModelOfInt32>.CountOfChild))
                       .IsRequired();
            ...
            typeBuilder.HasMany(cEntityModelType,
                                nameof(IChildEntityModelOfInt32<EntityModelOfInt32>.Children))
                       .WithOne(nameof(IParentEntityModelOfInt32<EntityModelOfInt32>.Parent))
                       .HasForeignKey(nameof(IParentEntityModelOfInt32<EntityModelOfInt32>.ParentId))
                       .HasConstraintName($"FK_{cTableName}_{nameof(IParentEntityModelOfInt32<EntityModelOfInt32>.ParentId)}");
        }
