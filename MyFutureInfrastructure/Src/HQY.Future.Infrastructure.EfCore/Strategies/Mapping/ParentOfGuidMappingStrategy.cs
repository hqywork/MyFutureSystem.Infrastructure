...
{
    /// <summary>
    /// 应用于 <see cref="IParentEntityModelOfGuid{TParentModel}"/> 实现类型的映射策略。
    /// </summary>
    public class ParentOfGuidMappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(IParentEntityModelOfGuid<>));
        }
        ...
        public virtual void Mapping(ModelBuilder builder, Type modelType)
        {
            ...
            builder.Entity(modelType)
                   .Property(nameof(IParentEntityModelOfGuid<EntityModelOfGuid>.ParentId))
                   .IsRequired();
        }
