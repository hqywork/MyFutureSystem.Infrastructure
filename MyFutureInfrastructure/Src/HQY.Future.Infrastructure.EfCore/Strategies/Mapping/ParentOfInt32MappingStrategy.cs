...
{
    /// <summary>
    /// 应用于 <see cref="IParentEntityModelOfInt32{TParentModel}"/> 实现类型的映射策略。
    /// </summary>
    public class ParentOfInt32MappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(IParentEntityModelOfInt32<>));
        }
