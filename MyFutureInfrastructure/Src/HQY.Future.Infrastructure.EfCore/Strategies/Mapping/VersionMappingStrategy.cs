...
{
    /// <summary>
    /// 应用于 <see cref="IVersionOfEntityModel"/> 实现类型的映射策略。
    /// </summary>
    public class VersionMappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(IVersionOfEntityModel));
        }
        ...
        public void Mapping(ModelBuilder builder, Type modelType)
        {
            ...
            typeBuilder.Property(nameof(IVersionOfEntityModel.Version))
                       .IsRowVersion();
        }
