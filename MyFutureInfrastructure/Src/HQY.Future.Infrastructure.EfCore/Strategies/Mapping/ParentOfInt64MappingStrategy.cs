...
{
    /// <summary>
    /// 应用于 <see cref="IParentEntityModelOfInt64{TParentModel}"/> 实现类型的映射策略。
    /// </summary>
    public class ParentOfInt64MappingStrategy : IMappingStrategy
    {
        #region Methods
        ...
        {
            return modelType.IsDerivedFrom(typeof(IParentEntityModelOfInt64<>));
        }
        ...
        public virtual void Mapping(ModelBuilder builder, Type modelType)
        {
            ...
            builder.Entity(modelType)
                   .Property(nameof(IParentEntityModelOfInt64<EntityModelOfInt64>.ParentId))
                   .IsRequired();
        }
