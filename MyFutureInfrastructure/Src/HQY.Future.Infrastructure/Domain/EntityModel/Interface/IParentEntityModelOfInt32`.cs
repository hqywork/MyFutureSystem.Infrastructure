...
{
    /// <summary>
    /// <para>实现此接口的实体模型意味着拥有表示父实体（唯一标识的类型为 <see cref="Int32"/>）的关联属性。</para>
    /// <para>一般情况下，此接口应用于“One-to-Many”关系中表示“Many”的实体模型中。</para>
    /// </summary>
    /// <typeparam name="TParentModel">所关联的父实体模型的类型。</typeparam>
    public interface IParentEntityModelOfInt32<TParentModel> where TParentModel : EntityModelOfInt32
    {
        #region Properties
