...
{
    /// <summary>
    /// <para>实现此接口的实体模型意味着拥有一组表示子实体（唯一标识的类型为 <see cref="Guid"/>）的关联属性。</para>
    /// <para>一般情况下，此接口应用于“One-to-Many”关系中表示“One”的实体模型中。</para>
    /// </summary>
    /// <typeparam name="TChildModel">所关联的子实体模型的类型。</typeparam>
    public interface IChildEntityModelOfGuid<TChildModel> : IChildEntityModel where TChildModel : EntityModelOfGuid
    {
        #region Properties
